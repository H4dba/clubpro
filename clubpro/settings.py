"""
Django settings for clubpro project.
...
WSGI_APPLICATION = 'clubpro.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@clubpro.com.br')
