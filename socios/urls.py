...
urlpatterns = [
    ...
    path('meu-perfil/renovar/', views_enhanced.renovar_assinatura, name='renovar_assinatura'),

    # AbacatePay payment flow
    path('pagamento/aguardando/<int:socio_id>/', views.pagamento_aguardando, name='pagamento_aguardando'),
    path('pagamento/sucesso/<int:socio_id>/', views.pagamento_sucesso, name='pagamento_sucesso'),
